...
const Navbar = () => {
  return (
    <>
      <nav className="flex justify-around items-center bg-[#050816]/40 backdrop-blur-md shadow-md border-b border-white/10 fixed top-0 left-0 w-full py-3 z-50">
        ...
        <div className="flex gap-6">
          ...
          <div>
            <button className="flex items-center border border-gray-300 rounded-md cursor-pointer">
              <a href="https://github.com/khaliqnoor/PassMate">
