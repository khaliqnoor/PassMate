    ...
    <div className="min-h-screen flex flex-col md:flex-row  bg-[#050816]">
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        ...
        <div>
          ...
          <h1 className="text-2xl md:text-4xl md:pb-2 font-bold bg-gradient-to-r from-white to-indigo-800 bg-clip-text text-transparent">
            Stop guessing passwords.
          </h1>
          <p className="text-xl md:text-3xl font-bold text-indigo-400 text-center max-w-72 md:max-w-md">
            Start storing them.
          </p>
        </div>
